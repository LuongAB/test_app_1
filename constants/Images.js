...
const Mosquito = require("../assets/imgs/mosquito.png");
const Review = require("../assets/imgs/customer-review.png");
const Splash = require("../assets/splash.png");
const logo = require("../assets/logo.png");
const placeholder = require("../assets/placeholder.png");
const poster = require("../assets/poster.png");
const aboutImage = require("../assets/logo1.png");
const flagUSA = require("../assets/flag_usa.png");
const flagVN = require("../assets/flag_vietnam.png");
